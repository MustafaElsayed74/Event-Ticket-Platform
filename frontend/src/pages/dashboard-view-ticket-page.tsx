...
const DashboardViewTicketPage: React.FC = () => {
  ...
  console.log('eventStart type:', typeof ticket.eventStart, 'value:', ticket.eventStart);
  console.log('eventEnd type:', typeof ticket.eventEnd, 'value:', ticket.eventEnd);
      ...
      <div className="w-full max-w-md">
        <div className="relative bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="flex items-center gap-2 text-purple-300 mb-8">
            ...
            <div>
              {ticket.eventStart && !isNaN(new Date(ticket.eventStart).getTime()) 
                ? format(new Date(ticket.eventStart), "Pp") 
                : "Date not available"} -{" "}
              {ticket.eventEnd && !isNaN(new Date(ticket.eventEnd).getTime()) 
